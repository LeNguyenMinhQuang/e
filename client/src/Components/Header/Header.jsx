...
function Header() {
    ...
    const [showModalUserTab, setShowModalUserTab] = useState(false);
    const [showModalHelp, setShowModalHelp] = useState(false);
    const [showModalLove, setShowModalLove] = useState(false);
    ...
    // Cart
    const cartNumber = JSON.parse(localStorage.getItem("cart"))?.length || 0;
    // Scroll position
    const setScroll = () => {
        ...
        if (currentPostion > lastPosition.current) {
            headerRef.current.style.top = "-80px";
            lastPosition.current = currentPostion;
        } else {
    ...
    return (
        <Wrapper ref={headerRef}>
            <div className="headerPart top d-flex center">
                <div className="container d-flex space-between">
                    ...
                    <div className="buttons d-flex">
                        ...
                        >
                            <Cart />
                            <span className="bag">Cart ({cartNumber})</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className="headerPart bot d-flex center">
                <div className="container d-flex space-between">
                    <div className="buttons d-flex">
                        <Link
                        ...
                        >
                            <p>WOMEN'S</p>
                            <div className="modal d-flex center">
                                <ModalHover />
                            </div>
                        </Link>
                        <Link
            ...
            {showModalCart && (
                <ModalLeft
                    setShow={setShowModalCart}
                    modalType={"cart"}
                    text={`MY CART (${cartNumber})`}
                />
            )}
            {showModalSearch && <ModalSearch setShow={setShowModalSearch} />}
        </Wrapper>
    );
}
